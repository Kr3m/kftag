...
textures/evil8_floor/e8cretefloor_tile
{
	surfaceparm metalsteps
	{
		map $lightmap
	...
	{
		map textures/swelt_evil8_floor/e8cretefloor_tile.jpg
		blendfunc filter
		rgbGen identity
	}
}
...
{
	qer_editorimage textures/swelt_evil8_fx/jumppad1_1.tga
	q3map_lightimage textures/swelt_evil8_fx/jumppad1_1.fx.tga
	surfaceparm nomarks
	surfaceparm nodamage
	q3map_surfacelight 1000

	{
		clampmap textures/swelt_evil8_fx/jumppad1_1.fx.tga
		tcMod stretch sawtooth .1 6.5 1 1
		rgbGen identity
	}
	{
		clampmap textures/swelt_evil8_fx/jumppad1_2.fx.tga
		tcMod stretch sawtooth .1 6.5 1 1.4
		rgbGen identity#
                blendfunc add
	}
	{
		map textures/swelt_evil8_fx/jumppad1_4.tga
		blendfunc blend
		rgbGen identity
	}
	{
		map textures/swelt_evil8_fx/jumppad1_1.blend.tga
		blendfunc add
		rgbGen wave inversesawtooth 1 1 0.9 0.7
	}
	{
		map $lightmap
		rgbGen identity
...
{
	//qer_editorimage textures/swelt_evil8_floor/e8clangfloor.tga
	surfaceparm metalsteps
	{
		map $lightmap
		rgbGen identity
