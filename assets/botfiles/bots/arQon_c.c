...
skill 5
{
	CHARACTERISTIC_NAME				"arQon"
	CHARACTERISTIC_GENDER			"male"
	CHARACTERISTIC_ATTACK_SKILL		1.0
	CHARACTERISTIC_WEAPONWEIGHTS	"bots/arQon_w.c"
	...
	CHARACTERISTIC_REACTIONTIME		0.66

	CHARACTERISTIC_CHAT_FILE			"bots/arQon_t.c"
	CHARACTERISTIC_CHAT_NAME			"arQon"
	...
	CHARACTERISTIC_ITEMWEIGHTS			"bots/arQon_i.c"
