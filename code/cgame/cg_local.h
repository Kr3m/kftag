...
extern enemyIndicator_t enemyIndicator;
...
void CG_LocalEventCvarChanged_cg_enemyIndicatorAdjust(cvarTable_t* cvart);
void CG_LocalEventCvarChanged_cg_enemyIndicatorColor(cvarTable_t* cvart);
void CG_LocalEventCvarChanged_cg_enemyIndicatorOpaque(cvarTable_t* cvart);
void CG_LocalEventCvarChanged_cg_enemyIndicatorBgColor(cvarTable_t* cvart);
void CG_LocalEventCvarChanged_cg_enemyIndicatorBgOpaque(cvarTable_t* cvart);
void CG_LocalEventCvarChanged_cg_enemyIndicatorOffset(cvarTable_t* cvart);
void CG_LocalEventCvarChanged_cg_enemyIndicatorMaxLength(cvarTable_t* cvart);
void CG_LocalEventCvarChanged_cg_enemyIndicatorFont(cvarTable_t* cvart);
