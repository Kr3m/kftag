...
G_CVAR( g_startArmor, "g_startArmor", "0", CVAR_SERVERINFO, 0, qfalse, qfalse )
G_CVAR( g_startHealth, "g_startHealth", "0", CVAR_SERVERINFO, 0, qfalse, qfalse )
...
G_CVAR( g_powerupReset, "g_powerupReset", "0", CVAR_ARCHIVE | CVAR_SERVERINFO, 0, qfalse, qfalse )
...
G_CVAR( g_grappleOffset, "g_grappleOffset", "100.0", 0, 0, qtrue, qfalse )

G_CVAR( pmove_crouchSlide, "pmove_crouchSlide", "0", CVAR_SERVERINFO, 0, qtrue, qfalse )
...
G_CVAR( g_disableHMG, "g_disableHMG", "0", CVAR_SERVERINFO, 0, qfalse, qfalse )
...
G_CVAR( g_followAttacker, "g_followAttacker", "0", CVAR_ARCHIVE, 0, qfalse, qfalse )
